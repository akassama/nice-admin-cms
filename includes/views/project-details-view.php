         ...
         <div class="card">
            <div class="card-body p-2">
               <table class="table table-bordered">
                  <tbody>
                     <tr>
                        <td class="tw-15 bg-light font-weight-bold">Title</td>
                        <td>Sample project title</td> 
                     </tr>
                     <tr>
                        <td class="tw-15 bg-light font-weight-bold">Slug</td>
                        <td>/sampl-project-title</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="fixed-content-h-20 pt-1 pb-1 bg-light p-1">
                              <div class="row">
                                 <img src="https://via.placeholder.com/150x125/F5F5DC/800000/?text=Gallery" class="img-thumbnail m-2 col-3" alt="Gallery" height="125">
                                 <img src="https://via.placeholder.com/150x125/F5F5DC/800000/?text=Gallery" class="img-thumbnail m-2 col-3" alt="Gallery" height="125">
                                 <img src="https://via.placeholder.com/150x125/F5F5DC/800000/?text=Gallery" class="img-thumbnail m-2 col-3" alt="Gallery" height="125">
                              </div>
                           </div>
