<section class="section">
      <div class="row">
        <div class="col-12">
          <a href="../media/upload-pdf.php" class="float-end mb-2">
            <button type="button" class="btn btn-outline-primary">
              <i class="bi bi-plus"></i>Upload PDF
            </button>
          </a>
        </div>
        <div class="col-lg-12">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="#" class="text-danger">
                            <i class="bx bxs-file-pdf icon-50"></i>
                        </a>
                    </td>
                    <td>Happy PDF</td>
                    <td>
                        <span class="text-primary">happy-pdf-file.jpg</span>
                    </td>
                    <td>
